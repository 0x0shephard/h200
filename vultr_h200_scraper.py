#!/usr/bin/env python3
"""
Vultr H200 GPU Price Scraper
Extracts H200 pricing from Vultr

Reference: https://www.vultr.com/pricing/
"""
...
class VultrH200Scraper:
    """Scraper for Vultr H200 pricing"""

    def __init__(self):
        self.name = "Vultr"
        self.base_url = "https://www.vultr.com/pricing/"
        self.headers = {
    ...
    def get_h200_prices(self) -> Dict[str, str]:
        """Main method to extract H200 prices from Vultr"""
        ...
        methods = [
            ("Vultr Pricing Page Scraping", self._try_pricing_page),
    ...
    def _try_pricing_page(self) -> Dict[str, str]:
        """Scrape the Vultr pricing page for H200 prices"""
        h200_prices = {}
    ...
    def _try_selenium_scraper(self) -> Dict[str, str]:
        ...
        try:
            ...
            try:
                print(f"    Loading Vultr pricing page...")
    ...
    def _normalize_prices(self, prices: Dict[str, str]) -> Dict[str, str]:
        ...
        print("\n   📊 Normalizing Vultr H200 pricing...")
    ...
    def save_to_json(self, prices: Dict[str, str], filename: str = "vultr_h200_prices.json") -> bool:
...
def main():
    """Main function to run the Vultr H200 scraper"""
    print("🚀 Vultr H200 GPU Pricing Scraper")
    print("=" * 80)

    scraper = VultrH200Scraper()
