#!/usr/bin/env python3
"""
Gcore H200 GPU Price Scraper
Extracts H200 pricing from Gcore

Reference: https://gcore.com/pricing/ai
"""
...
class GcoreH200Scraper:
    """Scraper for Gcore H200 pricing"""

    def __init__(self):
        self.name = "Gcore"
        self.base_url = "https://gcore.com/pricing/ai"
        self.headers = {
    ...
    def get_h200_prices(self) -> Dict[str, str]:
        """Main method to extract H200 prices from Gcore"""
        ...
        methods = [
            ("Gcore Pricing Page Scraping", self._try_pricing_page),
    ...
    def _try_pricing_page(self) -> Dict[str, str]:
        """Scrape the Gcore pricing page for H200 prices"""
        h200_prices = {}
    ...
    def _try_selenium_scraper(self) -> Dict[str, str]:
        ...
        try:
            ...
            try:
                print(f"    Loading Gcore pricing page...")
    ...
    def _normalize_prices(self, prices: Dict[str, str]) -> Dict[str, str]:
        ...
        print("\n   📊 Normalizing Gcore H200 pricing...")
    ...
    def save_to_json(self, prices: Dict[str, str], filename: str = "gcore_h200_prices.json") -> bool:
...
def main():
    """Main function to run the Gcore H200 scraper"""
    print("🚀 Gcore H200 GPU Pricing Scraper")
    print("=" * 80)

    scraper = GcoreH200Scraper()
