#!/usr/bin/env python3
"""
FluidStack H200 GPU Price Scraper
Extracts H200 pricing from FluidStack

Reference: https://www.fluidstack.io/resources/pricing
"""
...
class FluidStackH200Scraper:
    """Scraper for FluidStack H200 pricing"""

    def __init__(self):
        self.name = "FluidStack"
        self.base_url = "https://www.fluidstack.io/resources/pricing"
        self.headers = {
    ...
    def get_h200_prices(self) -> Dict[str, str]:
        """Main method to extract H200 prices from FluidStack"""
        ...
        methods = [
            ("FluidStack Pricing Page Scraping", self._try_pricing_page),
    ...
    def _try_pricing_page(self) -> Dict[str, str]:
        """Scrape the FluidStack pricing page for H200 prices"""
        h200_prices = {}
                ...
                if 'H200' in row_text and ('$' in row_text or 'USD' in row_text):
                    ...
                    for price_str in price_matches:
                        try:
                            ...
                            if 1.0 < price < 20.0:
                                variant_name = f"H200 (FluidStack)"
    ...
    def _try_selenium_scraper(self) -> Dict[str, str]:
        ...
        try:
            ...
            try:
                print(f"    Loading FluidStack pricing page...")
    ...
    def _normalize_prices(self, prices: Dict[str, str]) -> Dict[str, str]:
        ...
        print("\n   📊 Normalizing FluidStack H200 pricing...")
    ...
    def save_to_json(self, prices: Dict[str, str], filename: str = "fluidstack_h200_prices.json") -> bool:
...
def main():
    """Main function to run the FluidStack H200 scraper"""
    print("🚀 FluidStack H200 GPU Pricing Scraper")
    print("=" * 80)

    scraper = FluidStackH200Scraper()
