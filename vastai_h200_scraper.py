#!/usr/bin/env python3
"""
Vast.ai H200 GPU Price Scraper
Extracts H200 pricing from Vast.ai
...
class VastAIH200Scraper:
    """Scraper for Vast.ai H200 pricing"""

    def __init__(self):
        self.name = "VastAI"
        self.base_url = "https://vast.ai/pricing"
        self.console_url = "https://cloud.vast.ai/create/"
        self.headers = {
    ...
    def get_h200_prices(self) -> Dict[str, str]:
        """Main method to extract H200 prices from Vast.ai"""
        ...
        methods = [
            ("Vast.ai Pricing Page Scraping", self._try_pricing_page),
        ...
        if not h200_prices:
            ...
            print("    Note: Vast.ai has dynamic spot pricing, check their console")
        ...
        for variant, price_str in prices.items():
            ...
            try:
                ...
                if price_match:
                    ...
                    # Vast.ai typically has competitive pricing
                    if 0.5 < price < 20:
                        return True
            except:
                continue
    ...
    def _try_pricing_page(self) -> Dict[str, str]:
        """Scrape the Vast.ai pricing page for H200 prices"""
        h200_prices = {}
    ...
    def _try_selenium_scraper(self) -> Dict[str, str]:
        ...
        try:
            ...
            try:
                print(f"    Loading Vast.ai pricing page...")
    ...
    def _normalize_prices(self, prices: Dict[str, str]) -> Dict[str, str]:
        ...
        print("\n   📊 Normalizing Vast.ai H200 pricing...")
    ...
    def save_to_json(self, prices: Dict[str, str], filename: str = "vastai_h200_prices.json") -> bool:
        ...
        try:
            ...
            output_data = {
                ...
                "notes": {
                    ...
                    "pricing_type": "Spot/On-Demand (Dynamic)",
...
def main():
    """Main function to run the Vast.ai H200 scraper"""
    print("🚀 Vast.ai H200 GPU Pricing Scraper")
    print("=" * 80)

    scraper = VastAIH200Scraper()
