#!/usr/bin/env python3
"""
CoreWeave H200 GPU Price Scraper
Extracts H200 pricing from CoreWeave

Reference: https://www.coreweave.com/pricing
"""
...
class CoreWeaveH200Scraper:
    """Scraper for CoreWeave H200 pricing"""

    def __init__(self):
        self.name = "CoreWeave"
        self.base_url = "https://www.coreweave.com/pricing"
        self.headers = {
    ...
    def get_h200_prices(self) -> Dict[str, str]:
        """Main method to extract H200 prices from CoreWeave"""
        ...
        methods = [
            ("CoreWeave Pricing Page Scraping", self._try_pricing_page),
    ...
    def _try_pricing_page(self) -> Dict[str, str]:
        """Scrape the CoreWeave pricing page for H200 prices"""
        h200_prices = {}
    ...
    def _try_selenium_scraper(self) -> Dict[str, str]:
        ...
        try:
            ...
            try:
                print(f"    Loading CoreWeave pricing page...")
    ...
    def _normalize_prices(self, prices: Dict[str, str]) -> Dict[str, str]:
        ...
        print("\n   📊 Normalizing CoreWeave H200 pricing...")
    ...
    def save_to_json(self, prices: Dict[str, str], filename: str = "coreweave_h200_prices.json") -> bool:
...
def main():
    """Main function to run the CoreWeave H200 scraper"""
    print("🚀 CoreWeave H200 GPU Pricing Scraper")
    print("=" * 80)

    scraper = CoreWeaveH200Scraper()
